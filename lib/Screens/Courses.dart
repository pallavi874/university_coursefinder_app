...
//   final bookmarkspage = BookmarksPage();
//   @override
...
//       list.add(buildRecommendation(course[i]));
//     }
...
//     List<Widget> list = [];
//     for(var i = course.length-1;i >-1;i--) {
//       list.add(buildLastCollege(course[i]));
//     }
//     return list;
//   }
//
//   Widget buildLastCollege(Course course){
//     return GestureDetector(
//         onTap: () {
//           Navigator.push(
//             context,
